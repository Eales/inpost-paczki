...
- Translations no longer contain the callback URL literally; it is passed as a
  description placeholder, as `hassfest` requires. No functional change.
...
[0.1.1]: https://github.com/Eales/inpost-paczki/releases/tag/v0.1.1
